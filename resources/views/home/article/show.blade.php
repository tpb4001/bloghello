...
<div class="content" style="text-align: center;margin-right: 0px;">
  <header class="article-header">
	...
	<div class="article-meta"> <span class="item article-meta-time">
	  ...
	  </span> <span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="来源：{{ $article->copyform }}"><i class="glyphicon glyphicon-globe"></i> {{ $article->copyform }}</span> <span class="item article-meta-category" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="{{ $article->cates->cname }}"><i class="glyphicon glyphicon-list"></i> <a href="#" title="{{ $article->cates->cname }}" draggable="false">{{ $article->cates->cname }}</a></span> <span class="item article-meta-views" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="博主：{{ $article->abc->uname }}"><img src="/HomeStyle/images/ren.png" alt="" width="15px" height="13px"> <a href="/grbk/{{ $article->abc->id }}">{{ $article->abc->uname }}</a></span> <span class="item article-meta-comment" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="评论量"><i class="glyphicon glyphicon-comment">{{ $sum }}</i></span> </div>
  </header>
