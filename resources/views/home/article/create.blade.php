...
<form action="/detalis/article" method="post" enctype="multipart/form-data">
	{{ csrf_field() }}
	<input type="hidden" name="uname" value="{{ session('uname') }}">
  	...
  	<div class="form-group">
    	...
    	<input type="text" class="form-control" name="auth" placeholder="作者">
 	 </div>
 	 <div class="form-group">
    	<label for="exampleInputEmail1">文章来源</label>
    	<input type="text" class="form-control" name="copyform" placeholder="文章来源">
 	 </div>
 	 <div class="form-group">
