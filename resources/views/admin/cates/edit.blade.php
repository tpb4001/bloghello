          	...
          	<form class="mws-form" action="/admin/cates/{{ $data->id }}" method="post">
          		...
          		<div class="mws-form-block">
          			...
          			<div class="mws-form-row">
          				...
          				<div class="mws-form-item">
          					<input type="text" class="medium" name="cname" value="{{ $data->cname }}">
          				</div>
          			</div>
          			<div class="mws-form-row">
          				...
          				<div class="mws-form-item clearfix">
          					<ul class="mws-form-list">
          						<li><input type="radio" @if($data->status == 1) checked @endif name="status" value="1" id="s1"> <label for="s1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">激活</font></font></label></li>
          						<li><input type="radio" name="status" @if($data->status == 2) checked @endif  value="2" id="s2"> <label for="s2"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">未激活</font></font></label></li>
          					</ul>
          				</div>
          			</div>
          		</div>
